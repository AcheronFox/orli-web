...
const programs: IProgram = {
    ...
    content: [
        ...
        "<h4>Artist Alley</h4>",
        `<span>
            Your favourite artists and all those you don't know yet are eager for you to visit their booth and to grab tangible memories from them! Maybe you will get a deal here on the fursuit of your dreams or get a wonderful piece of art. Keep your wallet close, just in case!<br/>
        ...
        "<h4>Beach</h4>",
        `<span>
            If it's summer, then it's the waterfront! Jump right in the cooling waves of Lake Velence, enjoy the water and the sunshine! Access to the beach is unlimited during its opening hours!<br/>
        ...
        "<h4>Grill</h4>",
        `<span>
            The program that all försztivál attendees will definitely visit at least once. Every day from noon until dawn, the fire will be lit, and all the delicious food will be roasted on it. This program is of course weather dependent...<br/>
        ...
        "<h4>Biking around Lake Velence</h4>",
        `<span>
            ...
            You must take care of your bike and deal with any repairs if needed on the way! I'm sure that many of us will have tools or puncture repair kits on hand and we will help you and wait for you if needed, but please come in prepared just in case!<br/>
        ...
        `<span>
            Compete with others, enter the battle to win the table foosball or the ping-pong tournament where you will have to take on the toughest challenger at the end!<br/>
        ...
        "<h4>Photography</h4>",
        `<span>
            Your paws are too big to handle the selfie stick? During the festival look for the ShutterFurs crew and book your private or small group photoshoots with them!<br/>
            The recommended timeframe is right before sunset (during golden hour)!
        </span>`,
        "<br/>",

        "<h4>Requests Show and Picnic</h4>",
        `<span>
            You know the meme: \"What would be the first song that you would want to listen to on this sound system?\"<br/>
        ...
        "<h4>Organising: Questions & Answers</h4>",
        `<span>
