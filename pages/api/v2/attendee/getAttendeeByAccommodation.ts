import { getAttendeeByAccountKey, getAttendeeByAccomodationId } from "@/services/attendee/service.attendee.select";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        if ("id" in req.query) {
            ...
            const attendees = await getAttendeeByAccomodationId(requestId);
