...
export async function getFursona(id: number, connectionToUse?: PoolConnection): Promise<IFursona | undefined>
{
    ...
    return await executeSelectQuery<IFursona>(query, id, connectionToUse);
}
                                                        ...
                                                        limit: number = MAX_NUM_OF_FURSONAS, connectionToUse?: PoolConnection) : Promise<IFursona | undefined>
{
    ...
    return await executeSelectQuery<IFursona>(query, [hasFursuit, from, limit], connectionToUse);
}
                                               ...
                                               limit: number = MAX_NUM_OF_FURSONAS, connectionToUse?: PoolConnection) : Promise<IFursona | undefined>
{
    ...
    species = '%'+species+'%';
    return await executeSelectQuery<IFursona>(query, [species, from, limit], connectionToUse);
}
                                            ...
                                            limit: number = MAX_NUM_OF_FURSONAS, connectionToUse?: PoolConnection) : Promise<IFursona | undefined>
{
    ...
    return await executeSelectQuery<IFursona>(query, [name, from, limit], connectionToUse);
}