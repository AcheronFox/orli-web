...
export async function updateDailyTicket(dailyTicket: IDailyTicket): Promise<number | undefined>
{
    ...
    return await executeUpdateQuery(query, [editable, dailyTicket.id]);
}