    ...
    return (
        <section className={styles.InfoCard}>
            ...
            <div className={styles.InfoCard__Content}>
                <h3 className={styles.InfoCard__Content__Description}>{props.description}</h3>
                <p className={styles.InfoCard__Content__Time}>{props.time}</p>
                <p className={styles.InfoCard__Content__Text}>{props.text}</p>
            </div>
            <div className={styles.InfoCard__Button}>
                <PrimaryButton text={t("infoCardButton")} onClick={props.buttonAction}></PrimaryButton>
            </div>
