        ...
        <div className={styles.ParticipantCard}>
            ...
            <div className={styles.ParticipantCard__Picture}>
                <picture>
                    ...
                    <img srcSet={`${props.picture? (`uploads/${props.picture.split('.')[0]}_x1.jpg 1x, uploads/${props.picture.split('.')[0]}_x2.jpg 2x`) : 'Default_profile_x1.jpg 1x, Default_profile_x2.jpg 2x,'}`} alt="Participant Picture" src="Default_profile_x2.jpg" />
                </picture>
